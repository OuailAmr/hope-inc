...
<nav class="navbar navbar-expand-lg navbar-dark menu shadow fixed-top">
  <div class="container">
    ...
    <button class="navbar-toggler" onclick="myFunction()" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <div class="navigation">
      <ul class="navbar-nav">
        <li class="nav-item"><a class="nav-link active active2 homebtn" aria-current="page" href="index.php">Home</a></li>
      ...
      <div class="btndiv">
        <button type="button" style="visibility:hidden;" onclick="window.location.href ='sign-up.php';" class="rounded-pill sign">
        Sign up

      </button>
      <button type="button"  onclick="window.location.href ='log-in.php';" class="rounded-pill log log2">
        Log in
      </button>
				...
				<div class="block">
					...
					<div class="content text-center">
						...
						<form action="#">
							...
							<!-- Email -->
							<input class="form-control main" type="email" placeholder="Email Address" name="name" required>
							<!-- Password -->
							<input class="form-control main" type="password" placeholder="Password"  name="name" required>
              <input class="form-control main" type="password" placeholder="Confirm the password" name="name" required>
							<!-- Submit Button -->
							<button class="btn btn-main-md subbtn">sign up</button>
						</form>
						<div class="new-acount">
							<p class="subtext">By clicking “Sign Up” I agree to <a href="privacy-policy.php">Terms of Conditions.</a></p>
							<p class="subtext">Anready have an account? <a href="log-in.php">SIGN IN</a></p>
						</div>
					</div>
				</div>
			</div>
